                ...
                >
                        ...
                        animate={{
                            background: isDark
                                ? [
                                    ...
                                    "linear-gradient(225deg, #8b5cf6 0%, #d946ef 50%, #ec4899 100%)",
                                    "linear-gradient(315deg, #d946ef 0%, #6366f1 50%, #8b5cf6 100%)",
                                    "linear-gradient(135deg, #6366f1 0%, #8b5cf6 50%, #d946ef 100%)",
                                ]
                                : [
                    ...
                    <div className="absolute inset-0">
                        <motion.div
                            ...
                            style={{
                                background: `conic-gradient(from 0deg at 50% 50%, ${isDark ? "rgba(147, 51, 234, 0.4)" : "rgba(59, 130, 246, 0.4)"} 0deg, transparent 120deg, ${isDark ? "rgba(217, 70, 239, 0.4)" : "rgba(99, 102, 241, 0.4)"} 240deg, transparent 360deg)`,
                            }}
                        />
                        ...
                        <motion.div
                            ...
                            style={{
                                background: `conic-gradient(from 180deg at 50% 50%, ${isDark ? "rgba(217, 70, 239, 0.3)" : "rgba(139, 92, 246, 0.3)"} 0deg, transparent 120deg, ${isDark ? "rgba(99, 102, 241, 0.3)" : "rgba(59, 130, 246, 0.3)"} 240deg, transparent 360deg)`,
                            }}
                        />
                    </div>
                    ...
                    <div className="absolute inset-0">
                        <motion.div
                            ...
                            style={{
                                background: `radial-gradient(circle, ${isDark ? "rgba(147, 51, 234, 0.6)" : "rgba(59, 130, 246, 0.6)"} 0%, transparent 70%)`,
                            }}
                        />
                        ...
                        <motion.div
                            ...
                            style={{
                                background: `radial-gradient(circle, ${isDark ? "rgba(217, 70, 239, 0.5)" : "rgba(99, 102, 241, 0.5)"} 0%, transparent 70%)`,
                            }}
                        />
                        ...
                        <motion.div
                            ...
                            style={{
                                background: `radial-gradient(circle, ${isDark ? "rgba(168, 85, 247, 0.4)" : "rgba(139, 92, 246, 0.4)"} 0%, transparent 70%)`,
                            }}
                        />
                    </div>
