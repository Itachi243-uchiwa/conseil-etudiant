...
import { getFeaturedNews, getFeaturedServices, getFeaturedEvents, getMediaUrl } from "@/lib/api"
            ...
            <section className="py-16">
                <div className="container">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-xl text-white/80 max-w-3xl mx-auto">Chargement du contenu...</p>
                    </div>
            ...
            <section className="py-16">
                <div className="container">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-xl text-red-400 max-w-3xl mx-auto">{error}</p>
                    </div>
                </div>
            </section>
        )
            ...
            <section className="py-16">
                <div className="container">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-xl text-white/80 max-w-3xl mx-auto">Aucun contenu featured disponible pour le moment</p>
                    </div>
                </div>
            </section>
        )
        ...
        <section ref={ref} className="py-12 md:py-16">
            <div className="container px-4 md:px-6">
                ...
                >
                    ...
                    <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto px-4 md:px-0">
                ...
                <motion.div
                    ...
                    className="w-full"
                >
                    <FeaturedCarousel items={featuredItems} className="h-[400px] md:h-[500px] w-full" />
                </motion.div>
            </div>
        </section>
    )
