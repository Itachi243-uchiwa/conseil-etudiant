...
import { inlineDocumentUrl } from "@/lib/members-api"
...
export default function DocumentRow({
    ...
    // Le relais du backend renvoie le fichier en application/pdf inline, ce que
    // Cloudinary ne fait pas : sans lui le navigateur télécharge au lieu d'afficher.
    ...
    return (
        ...
        {preview && isPdf && (
            <div className="px-4 pb-4">
                <PdfPreview url={inlineDocumentUrl(doc.id)} height={480} />
            </div>
        )}
        </div>
    )
